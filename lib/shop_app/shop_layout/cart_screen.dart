          ...
          child: provider.getCart == null
            ...
            children: [
              ...
              itemBuilder: (context, index) => buildFavItem(
                  provider.getCart!.data!.cartItems![index].product!),
              separatorBuilder: (context, index) => Divider(
                height: 2,
                color: Colors.grey,
              ),
              itemCount: provider.getCart!.data!.cartItems!.length),
        );
      },
    );
  }
...
Widget buildFavItem( ProductCart model) => Consumer<ShopProvider>(
  builder: (context, provider, child) {
    return Padding(
